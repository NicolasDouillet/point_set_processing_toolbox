function [M, u, v] = sphere_homeo_sfc_isotropic_splg(fctn_x, fctn_y, fctn_z, range_u, range_v, option_random_sampling)
%% sphere_homeo_sfc_isotropic_splg : function to isotropically sample a given sphere-homeomorphic surface.
%
...
[~, u_step] = meshgrid(linspace(-1,1,spl_v),linspace(-1,1,spl_u));
u_rand = 2*(rand(spl_u,spl_v) - 0.5);
...
end % sphere_homeo_sfc_isotropic_splg